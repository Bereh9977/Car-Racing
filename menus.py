...
class Menu:
    def __init__(self, x, y):
        self.x = x
        self.y = y
        self.imageStart = self.load_image("img/start.png", (289, 143))
        self.imageOptions = self.load_image("img/options.png", (289, 143))
        self.imageBack = self.load_image("img/back.png", (288, 103))
        self.leadorboard = self.load_image("img/leaderboard.png", (1234, 817))
        self.rating_btn = self.load_image("img/rating_btn.png", (287, 141))
        self.menu_back_bnt = self.load_image("img/menu_btn.png", (232, 83))
        self.on_music = self.load_image("img/on_music.png", (288, 103))
        self.off_music = self.load_image("img/off_music.png", (287, 103))
    ...
    def countdown(self, countdown_images, screen, roads, car, car1, car2, bot, aspect_ratio, mode_choice):
        overlay_music_in_loop("soundeffects/321go.mp3")
...
class ConfigurationMenu(ABC):
    def __init__(self, x, y):
        ...
        self.title_font = pygame.font.Font("fonts/AveriaSansLibre-Bold.ttf", 56)
    ...
    def check_click(self, pos):
        ...
        if self.buy_image_rect.collidepoint(pos):
            ...
            if self.score.purchase_item("winter", "map"):
                overlay_music_in_loop("Dsoundeffects/purchase.mp3")
