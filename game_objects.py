...
class Cars:
    def __init__(self, x, y, speed, max_speed, angle, current_image, controls):
        ...
        self.image = self.load_image(f"{current_image}")
        ...
        self.ice_image = pygame.image.load('img/ice-cube.png')  # Завантажуємо зображення льоду
...
class Bots(Cars):
    def __init__(self, x, y, speed, max_speed, angle, points):
        available_cars = [
            "img/car1.png", "img/car2.png", "img/car3.png", "img/car4.png", "img/car5.png"
        ]
