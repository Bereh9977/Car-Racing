...
class GameSys:
    def __init__(self):
        ...
        self.background = Background('D:/CarRacing/Background/backgroundMenu.png', 0)
        self.car = Cars(self.screen_width // 2, self.screen_height // 2, 0)
        self.menu = Menu(self.screen_width // 2 - 100, 250)
        self.roads = Roads('D:/CarRacing/Maps/map.png', 0)
...
class Menu:
    def __init__(self, x, y):
        ...
        self.imageStart = self.load_image("D:/CarRacing/ButtonsImages/startButton.png", (200, 80))
        self.imageOptions = self.load_image("D:/CarRacing/ButtonsImages/optionButton.png", (200, 80))
